...
<div class="terms-page">
    <div class="terms-wrapper">
        ...
        <div class="terms-content">
            <p>
                제 1 조 (목적)<br><br>
                본 약관은 큰(1)났조?가 운영하는 웹 사이트 (http://localhost:8080/WebTeamProject_01)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다. 
                <br><br>제 2 조 (용어의 정의)<br><br>
                ...
                <br><br>제 3 조 (약관의 공시 및 효력과 변경)<br><br>
